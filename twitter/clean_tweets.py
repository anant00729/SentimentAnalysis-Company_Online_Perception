...
def tweet_filtering(tweet: str):
    """
    Filters tweets that have non ascii characters
    tweet: raw tweet text
    returns: True if tweet has non ascii character else False
    """
...
def main():
    ...
    df = pd.read_csv('../training_data_formulation/training.1600000.processed.noemoticon.csv', sep=',', encoding='latin-1', names=columns)
